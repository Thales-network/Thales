...
//! Thales Chain Specifications and utilities for building them.
//!
...
pub fn get_chain_spec(para_id: ParaId) -> ChainSpec {
	ChainSpec::from_genesis(
		...
		// Or maybe Apps can be smart enough to say if the string contains "thales" at all...
		"Thales Development Testnet",
		"local_testnet",
		ChainType::Local,
		move || {
...
pub fn thales_inflation_config() -> InflationInfo<Balance> {
	InflationInfo {
		expect: Range {
			min: 100_000 * GLMR,
			ideal: 200_000 * GLMR,
...
pub fn testnet_genesis(
	...
	// TODO consider whether this should be imported from thales precompiles
	...
	GenesisConfig {
		...
		pallet_evm: EVMConfig {
			...
			// the runtime/thales precompiles and systematically fill them with code
