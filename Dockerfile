...
# Download thales repo
RUN git clone https://github.com/thales-network/thales /thales
RUN cd /thales && git submodule init && git submodule update
...
# dependencies.
CMD cargo run --bin thales "--$PROFILE" -- --dev
