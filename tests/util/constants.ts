export const SPECS_PATH = `./thales-test-specs`;

export const DEBUG_MODE = process.env.DEBUG_MODE || false;
export const DISPLAY_LOG = process.env.THALES_LOG || false;
export const THALES_LOG = process.env.THALES_LOG || "info";

export const BINARY_PATH = process.env.BINARY_PATH || `../target/release/thales`;
